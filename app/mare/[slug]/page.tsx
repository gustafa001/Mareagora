          ...
          <div className="flex flex-col gap-8">
            ...
            <section className="classic-card prose prose-slate max-w-none">
              ...
              <p className="text-gray-600 leading-relaxed text-sm">
                A tábua de maré de {port.name} é essencial para pescadores, surfistas, mergulhadores e navegantes
                que frequentam o litoral de {port.state}. Os dados apresentados pelo MaréAgora são baseados nas
              ...
              <div className="grid md:grid-cols-2 gap-8 mt-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Ela indica os horários e alturas das marés altas e baixas ao longo do dia. Para a pesca,
                    os momentos de virada (quando a maré muda de direção) costumam ser muito produtivos.
                  </p>
                </div>
                <div>
