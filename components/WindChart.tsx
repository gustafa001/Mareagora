...
const styles = {
  ...
  title: { color: "#E0F7FF", fontSize: 14, fontWeight: 600, letterSpacing: "0.04em" } as React.CSSProperties,
  legend: { display: "flex", gap: 12, alignItems: "center" } as React.CSSProperties,
  tick: { fill: "rgba(224,247,255,0.45)", fontSize: 10, fontFamily: "monospace" },
  dirRow: { display: "flex", justifyContent: "space-around", alignItems: "center", marginTop: 8, padding: "4px 0", borderTop: "1px solid rgba(0,212,255,0.08)" } as React.CSSProperties,
  dirItem: { display: "flex", flexDirection: "column" as const, alignItems: "center", gap: 2 },
  dirLabel: { fontSize: 9, fontFamily: "monospace", letterSpacing: "0.05em" } as React.CSSProperties,
  bftScale: { display: "flex", justifyContent: "space-between", marginTop: 10, padding: "6px 0 0", borderTop: "1px solid rgba(0,212,255,0.08)" } as React.CSSProperties,
  bftItem: { display: "flex", alignItems: "center", gap: 5 } as React.CSSProperties,
  bftLabel: { color: "rgba(224,247,255,0.45)", fontSize: 9, fontFamily: "monospace" } as React.CSSProperties,
  tooltip: { background: "rgba(4,14,31,0.92)", border: "1px solid rgba(0,212,255,0.25)", borderRadius: 10, padding: "10px 14px", fontSize: 12 } as React.CSSProperties,
  tooltipDate: { color: "rgba(224,247,255,0.6)", fontSize: 11, marginBottom: 6, fontFamily: "monospace" } as React.CSSProperties,
  tooltipRow: { display: "flex", justifyContent: "space-between", gap: 20, marginBottom: 4 } as React.CSSProperties,
  tooltipCond: { marginTop: 6, fontSize: 11, fontWeight: 700, textAlign: "center" as const },
};
