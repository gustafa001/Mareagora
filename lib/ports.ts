...
export const PORTS: Port[] = [
  ...
  { id: '4',  name: 'Ilha dos Guarás',                    slug: 'ilha-dos-guaras',                    state: 'PA', region: 'norte',    dataFile: '4_-_ilha_dos_guaras_estado_do_para_-_2026__22_-_24.json' },
  { id: '5',  name: 'Fundeadouro de Salinópolis',         slug: 'fundeadouro-de-salinopolis',         state: 'PA', region: 'norte',    dataFile: '5_-fundeadouro_de_salinopolis___25_-_27.json' },
  { id: '6',  name: 'Ilha do Mosqueiro',                  slug: 'ilha-do-mosqueiro',                  state: 'PA', region: 'norte',    dataFile: '6_-_ilha_do_mosqueiro_28_-_30.json' },
  { id: '7',  name: 'Porto de Belém',                     slug: 'porto-de-belem',                     state: 'PA', region: 'norte',    dataFile: '7_-_porto_de_belem__estado_do_para_-_2026_-_31_-_33.json' },
  ...
  // Região Nordeste
  { id: '10', name: 'São Luís',                           slug: 'sao-luis',                           state: 'MA', region: 'nordeste', dataFile: '10_-_sao_luis_40_-_42.json' },
  ...
  { id: '14', name: 'Porto de Tutóia',                    slug: 'porto-de-tutoia',                    state: 'MA', region: 'nordeste', dataFile: '14_-_porto_de_tutoia_-_52_-_54.json' },
  { id: '15', name: 'Porto de Luís Correia',              slug: 'porto-de-luis-correia',              state: 'PI', region: 'nordeste', dataFile: '15_-_porto_de_luis_correia_55_-_57.json' },
  { id: '16', name: 'Terminal Portuário do Pecém',        slug: 'terminal-portuario-do-pecem',        state: 'CE', region: 'nordeste', dataFile: '16_-_terminal_portuario_do_pecem_-_58_-_60.json' },
  ...
  { id: '18', name: 'Arquipélago de Fernando de Noronha', slug: 'arquipelago-de-fernando-de-noronha', state: 'PE', region: 'nordeste', dataFile: '18_-_arquipelago_de_fernando_de_noronha_64_-_66.json' },
  { id: '20', name: 'Porto de Macau',                     slug: 'porto-de-macau',                     state: 'RN', region: 'nordeste', dataFile: '20_-_porto_de_macau_-_70_-_72.json' },
  { id: '21', name: 'Porto de Guamaré',                   slug: 'porto-de-guamare',                   state: 'RN', region: 'nordeste', dataFile: '21_-_porto_de_guamare_-73_-_75.json' },
  ...
  { id: '26', name: 'Porto de Maceió',                    slug: 'porto-de-maceio',                    state: 'AL', region: 'nordeste', dataFile: '26_-_porto_de_maceio_-_88_-90.json' },
  ...
  { id: '32', name: 'Porto de Ilhéus - Malhado',          slug: 'porto-de-ilheus',                    state: 'BA', region: 'nordeste', dataFile: '32_-_porto_de_ilheus_-_malhado_-_106_-_108.json' },
  ...
  { id: '34', name: 'Porto de Tubarão',                   slug: 'porto-de-tubarao',                   state: 'ES', region: 'sudeste',  dataFile: '34_-_porto_de_tubarao_-_112_-_114.json' },
  { id: '35', name: 'Porto de Vitória',                   slug: 'porto-de-vitoria',                   state: 'ES', region: 'sudeste',  dataFile: '35_-_porto_de_vitoria_-_115_-_117.json' },
  ...
  { id: '38', name: 'Porto do Açu',                       slug: 'porto-do-acu',                       state: 'RJ', region: 'sudeste',  dataFile: '38_-_porto_do_acu_-_124_-_126.json' },
  { id: '39', name: 'Terminal Marítimo de Imbetiba',      slug: 'terminal-maritimo-de-imbetiba',      state: 'RJ', region: 'sudeste',  dataFile: '39_-_terminal_maritimo_de_imbetiba_-_127_-_129.json' },
  ...
  { id: '41', name: 'Porto de Itaguaí',                   slug: 'porto-de-itaguai',                   state: 'RJ', region: 'sudeste',  dataFile: '41_-_porto_de_itaguai_-_133_-_135.json' },
  { id: '42', name: 'Porto do Forno',                     slug: 'porto-do-forno',                     state: 'RJ', region: 'sudeste',  dataFile: '42_-_porto_do_forno_-_136_-_138.json' },
  { id: '43', name: 'Terminal da Ilha Guaíba',            slug: 'terminal-da-ilha-guaiba',            state: 'RJ', region: 'sudeste',  dataFile: '43_-_terminal_da_ilha_guaiba_-_139_-_141.json' },
  ...
  { id: '45', name: 'Porto de São Sebastião',             slug: 'porto-de-sao-sebastiao',             state: 'SP', region: 'sudeste',  dataFile: '45_-_porto_de_sao_sebastiao_-_145_-_147.json' },
  { id: '46', name: 'Porto de Santos',                    slug: 'porto-de-santos',                    state: 'SP', region: 'sudeste',  dataFile: '46_-_porto_de_santos_-_148_-_150.json' },
  { id: '47', name: 'Terminal Portuário da Ponta do Félix', slug: 'terminal-portuario-da-ponta-do-felix', state: 'SP', region: 'sudeste', dataFile: '47_-_terminal_portuario_da_ponta_do_felix_151_-_153.json' },

  // Região Sul
  { id: '48', name: 'Porto de Paranaguá - Cais Oeste',   slug: 'porto-de-paranagua',                 state: 'PR', region: 'sul',      dataFile: '48_-_porto_de_paranagua_-_cais_oeste_-_154_-_156.json' },
  { id: '49', name: 'Barra de Paranaguá - Canal Sueste', slug: 'barra-de-paranagua-sueste',          state: 'PR', region: 'sul',      dataFile: '49_-_barra_de_paranagua_-_canal_sueste_157_-_159.json' },
  { id: '50', name: 'Barra de Paranaguá - Canal da Galheta', slug: 'barra-de-paranagua-galheta',     state: 'PR', region: 'sul',      dataFile: '50_-_barra_de_paranagua_-_canal_da_galheta_160_-162.json' },
  { id: '51', name: 'Porto de São Francisco do Sul',     slug: 'porto-de-sao-francisco-do-sul',      state: 'SC', region: 'sul',      dataFile: '51_-_porto_de_sao_francisco_do_sul_-_163_-165.json' },
  { id: '52', name: 'Porto de Itajaí',                   slug: 'porto-de-itajai',                    state: 'SC', region: 'sul',      dataFile: '52_-_porto_de_itajai_-_166_-_168.json' },
  { id: '53', name: 'Porto de Florianópolis',            slug: 'porto-de-florianopolis',              state: 'SC', region: 'sul',      dataFile: '53_-_porto_de_florianopolis_-_169_-_171.json' },
  { id: '54', name: 'Porto de Imbituba',                 slug: 'porto-de-imbituba',                   state: 'SC', region: 'sul',      dataFile: '54_-_porto_de_imbituba_-_172_-_174.json' },
