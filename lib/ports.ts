...
export const PORTS: Port[] = [
  ...
  { 
    ...
    cameras: [
      { title: 'Guarujá - Praia das Pitangueiras ao Vivo', sourceName: 'Marcelo Praia Grande e Região', sourceUrl: 'https://www.youtube.com/live/q5jrRV0Tc-Y', videoId: 'q5jrRV0Tc-Y' }
    ]
  },
  ...
  { id: '89', name: 'Calhetas',             cityName: 'Calhetas',             slug: 'calhetas',             state: 'PE', region: 'nordeste', lat: -8.294000,  lon: -34.955000, dhnId: '30686', offsetMinutes: 0, searchNames: ['calhetas', 'praia de calhetas'],   referencePortSlug: 'porto-de-suape' },
  { id: '90', name: 'Praia do Paiva',       cityName: 'Praia do Paiva',       slug: 'praia-do-paiva',       state: 'PE', region: 'nordeste', lat: -8.240000,  lon: -34.930000, dhnId: '30686', offsetMinutes: 0, searchNames: ['paiva', 'praia do paiva'],         referencePortSlug: 'porto-de-suape' },
  { id: '91', name: 'Farol de Nazaré',      cityName: 'Farol de Nazaré',      slug: 'farol-de-nazare',      state: 'PE', region: 'nordeste', lat: -8.396000,  lon: -34.955000, dhnId: '30686', offsetMinutes: 0, searchNames: ['farol de nazare', 'farol de nazaré', 'vila de nazare', 'nazare suape'], referencePortSlug: 'porto-de-suape' },
  ...
  { id: '92', name: 'Ilhabela',             cityName: 'Ilhabela',             slug: 'ilhabela',             state: 'SP', region: 'sudeste',  lat: -23.778000, lon: -45.359000, dhnId: '50210', offsetMinutes: 5, searchNames: ['ilhabela', 'praia de castelhanos', 'praia do castelhanos', 'ponta da praia'], referencePortSlug: 'porto-de-sao-sebastiao' },
  { id: '93', name: 'Ubatumirim',           cityName: 'Ubatumirim',           slug: 'ubatumirim',           state: 'SP', region: 'sudeste',  lat: -23.380000, lon: -45.050000, dhnId: '50210', offsetMinutes: 5, searchNames: ['ubatumirim', 'praia de ubatumirim'], referencePortSlug: 'porto-de-sao-sebastiao' },
  { id: '94', name: 'Barra Grande',         cityName: 'Barra Grande (PI)',    slug: 'barra-grande',         state: 'PI', region: 'nordeste', lat: -2.925000,  lon: -41.750000, dhnId: '30225', offsetMinutes: 15, searchNames: ['barra grande', 'barra grande piaui', 'barra grande pipa'], referencePortSlug: 'porto-de-luis-correia' },
  { id: '95', name: 'Praia do Rosa',        cityName: 'Praia do Rosa',        slug: 'praia-do-rosa',        state: 'SC', region: 'sul',      lat: -28.125000, lon: -48.633000, dhnId: '60250', offsetMinutes: 15, searchNames: ['praia do rosa', 'rosa', 'ilha do mel'], referencePortSlug: 'porto-de-imbituba' },
