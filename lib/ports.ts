...
export const PORTS: Port[] = [
  ...
  { id: '40', name: 'Porto do Rio de Janeiro - Ilha Fiscal',slug: 'rio-de-janeiro-fiscal',               state: 'RJ', region: 'sudeste',  lat: -22.90, lon: -43.17,  dataFile: '40_-_porto_do_rio_de_janeiro_-_i_fiscal_-_130_-_132.json' },
