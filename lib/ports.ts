...
export const PORTS: Port[] = [
  ...
  { id: '38', name: 'Porto do Açu',                         slug: 'porto-do-acu',                       state: 'RJ', region: 'sudeste',  dataFile: '38_-_porto_do_açu_-_124_-_126.json' },
  { id: '39', name: 'Terminal Marítimo de Imbetiba',        slug: 'terminal-maritimo-de-imbetiba',      state: 'RJ', region: 'sudeste',  dataFile: '39_-_terminal_marítimo_de_imbetiba_-_127_-_129.json' },
  ...
  { id: '53', name: 'Porto de Florianópolis',               slug: 'porto-de-florianopolis',             state: 'SC', region: 'sul',      dataFile: '53_-_porto_de_florianópolis_-_169_-_171.json' },
