...
export const PORTS: Port[] = [
  ...
  { id: '4',  name: 'Ilha dos Guarás',                       slug: 'ilha-dos-guaras',                      state: 'PA', region: 'norte',    lat: -0.93,  lon: -46.62,  dataFile: '4_-_4_-_ilha_dos_guaras__estado_do_para__-_2026__22_-_24.json' },
  { id: '5',  name: 'Fundeadouro de Salinópolis',            slug: 'fundeadouro-de-salinopolis',           state: 'PA', region: 'norte',    lat: -0.61,  lon: -47.35,  dataFile: '5_-_5_-fundeadouro_de_salinopolis____25_-_27.json' },
  { id: '6',  name: 'Ilha do Mosqueiro',                     slug: 'ilha-do-mosqueiro',                    state: 'PA', region: 'norte',    lat: -1.17,  lon: -48.38,  dataFile: '6_-_6_-_ilha_do_mosqueiro_28_-_30.json' },
